package dev.tr7zw.exordium.managers;
		...
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : Exordium.INSTANCE.getModuleManager().getModules()) {
					JsonElement moduleJson = profile.get(String.valueOf(Exordium.INSTANCE.getModuleManager().getModules().indexOf(module)));
		...
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : Exordium.INSTANCE.getModuleManager().getModules()) {
					...
					profile.add(String.valueOf(Exordium.INSTANCE.getModuleManager().getModules().indexOf(module)), moduleConfig);
				}

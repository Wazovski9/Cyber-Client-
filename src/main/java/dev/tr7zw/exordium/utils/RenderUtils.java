...
public final class RenderUtils {
	...
	public static void renderFilledBox(MatrixStack matrices, float f, float f2, float f3, float f4, float f5, float f6, Color color) {
		...
		// Front face
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), f, f2, f3).color(red, green, blue, alpha);
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), f, f2 + f5, f3).color(red, green, blue, alpha);
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), f + f4, f2 + f5, f3).color(red, green, blue, alpha);
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), f + f4, f2, f3).color(red, green, blue, alpha);

		// Back face
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), f, f2, f3 + f6).color(red, green, blue, alpha);
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), f + f4, f2, f3 + f6).color(red, green, blue, alpha);
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), f + f4, f2 + f5, f3 + f6).color(red, green, blue, alpha);
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), f, f2 + f5, f3 + f6).color(red, green, blue, alpha);
	...
	public static void renderLine(MatrixStack matrices, Color color, Vec3d start, Vec3d end) {
		...
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), (float) start.x, (float) start.y, (float) start.z).color(red, green, blue, alpha);
		bufferBuilder.vertex(matrices.peek().getPositionMatrix(), (float) end.x, (float) end.y, (float) end.z).color(red, green, blue, alpha);
		BufferRenderer.drawWithGlobalProgram(bufferBuilder.end());
	...
	private static void genericAABBRender(VertexFormat.DrawMode mode, VertexFormat format, Supplier<ShaderProgram> shader, Matrix4f stack, Vec3d start, Vec3d dimensions, Color color, RenderAction action) {
		...
		action.run(bufferBuilder, (float) start.x, (float) start.y, (float) start.z, (float) dimensions.x, (float) dimensions.y, (float) dimensions.z, red, green, blue, alpha, stack);

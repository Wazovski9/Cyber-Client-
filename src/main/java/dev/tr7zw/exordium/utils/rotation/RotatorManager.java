package dev.tr7zw.exordium.utils.rotation;

import dev.tr7zw.exordium.Exordium;
import dev.tr7zw.exordium.event.EventManager;
import dev.tr7zw.exordium.event.events.*;
import dev.tr7zw.exordium.utils.RotationUtils;
...
public final class RotatorManager implements PacketSendListener, BlockBreakingListener, ItemUseListener, AttackListener, MovementPacketListener, PacketReceiveListener {
	...
	private final EventManager eventManager = Exordium.INSTANCE.eventManager;
